// GET the home page
// Updating the homepage controller to be in charge of the data that is rendered on the page.
const homelist = (req, res) => {
    res.render('locations-list', {
        ...
        locations: [{
            name: 'Starcups',
            address: '125 High Street, Reading, RG4 1PS',
            rating: 5,
            facilities: ['Hot drinks', 'Food', 'Premium wifi'],
            distance: '100m'
        },{
            name: 'Cafe Hero',
            address: '125 High Screen, Reading, RG6 1PS',
            rating: 2,
    ...
    res.render('location-info', {
        ...
        location: {
            ...
            reviews: [{
                ...
                reviewText: 'What a great place. I can\'t say enough things about it'
            },{
                author: 'Kweku Prosper',
                rating: 4,
